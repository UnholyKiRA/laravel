                ...
                <div class="col-lg-6">
                    <ul class="about__icons__wrap">
                        <li>
                            ...
                            <img class="dark" src="{{asset('assets/img/icons/xd.png')}}" alt="XD">
                        </li>
                        <li>
                            <img class="light" src="{{asset('frontend/assets/img/icons/skeatch_light.png')}}" alt="Skeatch">
                            <img class="dark" src="{{asset('assets/img/icons/skeatch.png')}}" alt="Skeatch">
                        </li>
                        <li>
                            <img class="light" src="{{asset('frontend/assets/img/icons/illustrator_light.png')}}" alt="Illustrator">
                            <img class="dark" src="{{asset('assets/img/icons/illustrator.png')}}" alt="Illustrator">
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <img class="dark" src="{{asset('assets/img/icons/photoshop.png')}}" alt="Photoshop">
                        </li>
                        <li>
                            <img class="light" src="{{asset('frontend/assets/img/icons/figma_light.png')}}" alt="Figma">
                            <img class="dark" src="{{asset('assets/img/icons/figma.png')}}" alt="Figma">
                        </li>
                    </ul>
                </div>
                <div class="col-lg-6">
